...
import shop.readmecorp.userserverreadme.common.auth.jwt.MyJwtAuthorizationFilter;
import shop.readmecorp.userserverreadme.common.exception.Exception401;
import shop.readmecorp.userserverreadme.common.exception.Exception403;
import shop.readmecorp.userserverreadme.common.util.MyFilterResponseUtil;
...
public class MySecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests(
                authorize -> authorize.antMatchers("/payments/**", "/carts/**", "/questions/**", "/boot-pay/**").authenticated()
